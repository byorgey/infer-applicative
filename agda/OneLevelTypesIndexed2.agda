...
diamond : {υ : Ty b} → σ ◃ τ → σ ◃ υ → Σ[ φ ∈ ΣTy ] ((τ ◃ proj₂ φ) × (υ ◃ proj₂ φ))
...
... | (₀ , φ) , τ◃φ , υ◃φ = (₁ , □ φ) , box τ◃φ , pure υ◃φ
... | (₁ , φ) , τ◃φ , υ◃φ = (₁ , φ) , lemma τ◃φ , υ◃φ
diamond {b} (arr τ₁◃σ₁ σ₂◃τ₂) σ₁⇒σ₂◃υ with b
diamond {b} (arr τ₁◃σ₁ σ₂◃τ₂) σ₁⇒σ₂◃υ | ₀ with ⇒◃₀-inv σ₁⇒σ₂◃υ
diamond {b} (arr τ₁◃σ₁ σ₂◃τ₂) σ₁⇒σ₂◃υ | ₀ | (_ , υ₁) , (_ , υ₂) , refl = {!!}
